 ...
 * `toolPolicy:read`: View tools, tool invocation policies, and trusted data policies
 */
export const runPolicyDryRun = <ThrowOnError extends boolean = false>(options: Options<RunPolicyDryRunData, ThrowOnError>) => (options.client ?? client).post<RunPolicyDryRunResponses, RunPolicyDryRunErrors, ThrowOnError>({
